...
public class CEASTParser extends fr.upmc.ilp.ilp3.CEASTParser {
    ...
    public CEASTParser (IAST3esclFactory<CEASTparseException> factory) {
        super(factory);
    }
    
    @Override
    public IAST3esclFactory<CEASTparseException> getFactory () {
        return (IAST3esclFactory<CEASTparseException>) super.getFactory();
    }
